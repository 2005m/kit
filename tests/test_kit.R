...
x3 = as.numeric(x2)
x4 = as.raw(c(1,2,3))
x5 = sample(c(1:1000),1e5,TRUE)
x6 = sample(as.numeric(c(1:1000)),1e5,TRUE)
...
check("0001.067", topn(x0, 1001L), error = "Function 'topn' is not built for large value of 'n'. The algorithm is made for small values. Please prefer the 'order' function if you want to proceed with such large value.")
...
check("0005.005", psum(as.raw(z), y, na.rm = TRUE), error = "Argument 1 is of type raw. Only integer, double and complex types are supported.")
...
check("0006.016", pprod(x, y, z, na.rm = FALSE), c(6, NA, NA, 5))
check("0006.017", pprod(x, y, z, na.rm = TRUE), c(6, 12, 16, 5))
check("0006.018", pprod(as.integer(x), as.integer(y), as.integer(z), na.rm = FALSE), c(6L, NA_integer_, NA_integer_, 5L))
check("0006.019", pprod(as.integer(x), as.integer(y), as.integer(z), na.rm = TRUE), c(6L, 12L, 16L, 5L))
check("0006.020", pprod(as.raw(z), y, na.rm = TRUE), error = "Argument 1 is of type raw. Only integer, double and complex types are supported.")
check("0006.021", pprod(x, y, 1:2, na.rm = FALSE), error = "Argument 3 is of length 2 but argument 1 is of length 4. If you wish to 'recycle' your argument, please use rep() to make this intent clear to the readers of your code.")
check("0006.022", pprod(1:10, 1:5, na.rm = FALSE), error = "Argument 2 is of length 5 but argument 1 is of length 10. If you wish to 'recycle' your argument, please use rep() to make this intent clear to the readers of your code.")
check("0006.023", pprod(x, as.raw(z), y, na.rm = TRUE), error = "Argument 2 is of type raw. Only integer, double and complex types are supported.")
check("0006.024", pprod(1:10, 1:10, 21:30), 1:10 * 1:10 * 21:30)
check("0006.025", pprod(x, y, z, na.rm = NA), error = "Argument 'na.rm' must be TRUE or FALSE and length 1.")
check("0006.026", pprod(x, na.rm = FALSE), x)
check("0006.027", pprod(as.integer(x), y, z, na.rm = TRUE), c(6, 12, 16, 5))
check("0006.028", pprod(c(1,3,NA,5,NA), c(2,NA,4,1,NA), na.rm = TRUE), c(2, 3, 4, 5, 1))
check("0006.029", pprod(x, y, as.integer(z), na.rm = FALSE), c(6, NA, NA, 5))
check("0006.030", pprod(na.rm = FALSE), error = "Please supply at least 1 argument. (0 argument supplied)")
check("0006.031", pprod(x0, y0, z0), x0*y0*z0)
check("0006.032", pprod(as.complex(x0), as.complex(y0), as.complex(z0)), as.complex(x0)*as.complex(y0)*as.complex(z0))
check("0006.033", pprod(as.complex(x0), as.complex(y0), z0), as.complex(x0)*as.complex(y0)*z0)
check("0006.034", pprod(as.complex(x), as.complex(y), as.complex(z), na.rm = FALSE), as.complex(c(6, NA, NA, 5)))
check("0006.035", pprod(as.complex(x), as.complex(y), as.complex(z), na.rm = TRUE), as.complex(c(6, 12, 16, 5)))
check("0006.036", pprod(x, y, z, rep(Inf, 4L), na.rm = FALSE), x*y*z*Inf)
check("0006.037", pprod(x, y, z, rep(Inf, 4L), na.rm = TRUE), rep(Inf, 4L))
check("0006.038", pprod(NA_integer_, na.rm = TRUE), 1L)
check("0006.039", pprod(NA_real_, na.rm = TRUE), 1)
check("0006.040", pprod(NA_complex_, na.rm = TRUE), 1+0i)
...
x0 = sample(c(TRUE, FALSE, NA),1e6,TRUE)
y0 = sample(c(TRUE, FALSE, NA),1e6,TRUE)
z0 = sample(c(TRUE, FALSE, NA),1e6,TRUE)
...
check("0009.009", pall(as.double(z), y, na.rm = TRUE), error = "Argument 1 is of type double. Only logical type is supported.")
check("0009.010", pall(NA, na.rm = TRUE), TRUE)
check("0009.011", pall(NA, na.rm = FALSE), NA)
check("0009.012", pall(x0, y0, z0, na.rm = FALSE), sapply(1:1e6, function(i) all(x0[i],y0[i],z0[i],na.rm=FALSE)))
check("0009.013", pall(x0, y0, z0, na.rm = TRUE), sapply(1:1e6, function(i) all(x0[i],y0[i],z0[i],na.rm=TRUE)))
...
check("0010.009", pany(as.double(z), y, na.rm = TRUE), error = "Argument 1 is of type double. Only logical type is supported.")
check("0010.010", pany(NA, na.rm = TRUE), TRUE)
check("0010.011", pany(NA, na.rm = FALSE), NA)
check("0010.012", pany(x0, y0, z0, na.rm = FALSE), sapply(1:1e6, function(i) any(x0[i],y0[i],z0[i],na.rm=FALSE)))
check("0010.013", pany(x0, y0, z0, na.rm = TRUE), sapply(1:1e6, function(i) any(x0[i],y0[i],z0[i],na.rm=TRUE)))
...
y0 = rnorm(1000L)
z0 = rnorm(1000L)
x1 = sample(c(1,2,NA),1e3,TRUE)
y1 = sample(c(1,2,NA),1e3,TRUE)
z1 = sample(c(1,2,NA),1e3,TRUE)
...
check("0011.003", pmean(as.raw(z), y, na.rm = TRUE), error = "Argument 1 is of type raw. Only integer and double types are supported.")
...
check("0011.011", pmean(x0, y0, z0), sapply(1:1000, function(i) mean(c(x0[i], y0[i], z0[i]), na.rm = FALSE)))
...
check("0011.020", pmean(x0, y0, z0, na.rm = TRUE), sapply(1:1000, function(i) mean(c(x0[i], y0[i], z0[i]), na.rm = TRUE)))
check("0011.021", pmean(x1, y1, z1, na.rm = FALSE), sapply(1:1000, function(i) mean(c(x1[i], y1[i], z1[i]), na.rm = FALSE)))
check("0011.022", pmean(x1, y1, z1, na.rm = TRUE), sapply(1:1000, function(i) mean(c(x1[i], y1[i], z1[i]), na.rm = TRUE)))
...
x2 = sample(as.logical(c(1:1000,NA_integer_)),1e6,TRUE)
...
rdn = sample(c(1,NA_real_,NaN),1e4,TRUE)
...
check("0016.028", funique(matrix(x1[1:1000],ncol=10)), unique(matrix(x1[1:1000],ncol=10)))
check("0016.029", funique(matrix(x2[1:1000],ncol=10)), unique(matrix(x2[1:1000],ncol=10)))
check("0016.030", funique(matrix(x3[1:1000],ncol=10)), unique(matrix(x3[1:1000],ncol=10)))
check("0016.031", funique(matrix(x4[1:1000],ncol=10)), unique(matrix(x4[1:1000],ncol=10)))
check("0016.032", funique(matrix(x5[1:1000],ncol=10)), unique(matrix(x5[1:1000],ncol=10)))
...
check("0017.001", countOccur(iris$Species)[[2]], c(50L,50L,50L))
check("0017.002", countOccur(as.numeric(iris$Species))[[2]], c(50L,50L,50L))
check("0017.003", countOccur(as.complex(iris$Species))[[2]], c(50L,50L,50L))
check("0017.004", countOccur(as.character(iris$Species))[[2]], c(50L,50L,50L))
check("0017.005", countOccur(c(NA,TRUE,TRUE,FALSE,NA,FALSE))[[2]], c(2L,2L,2L))
...
check("0018.028", uniqLen(matrix(x1[1:1000],ncol=10)), dim(unique(matrix(x1[1:1000],ncol=10)))[1])
check("0018.029", uniqLen(matrix(x2[1:1000],ncol=10)), dim(unique(matrix(x2[1:1000],ncol=10)))[1])
check("0018.030", uniqLen(matrix(x3[1:1000],ncol=10)), dim(unique(matrix(x3[1:1000],ncol=10)))[1])
check("0018.031", uniqLen(matrix(x4[1:1000],ncol=10)), dim(unique(matrix(x4[1:1000],ncol=10)))[1])
check("0018.032", uniqLen(matrix(x5[1:1000],ncol=10)), dim(unique(matrix(x5[1:1000],ncol=10)))[1])
